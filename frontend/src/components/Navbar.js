...
const Navbar = () => {
  ...
  return (
    <div className="flex bg-blue-700 p-3 justify-between">
      ...
      {user && (<div className="flex justify-between items-center gap-1">  <FaUserCircle className="text-white text-xl"/><div className="text-white font-semibold text-xl">{user?.username}</div>
